...
const RegisterForm: React.FC<{ onSwitchTab: (tab: 'login') => void }> = ({ onSwitchTab }) => {
        ...
        <form onSubmit={handleSubmit} className="flex w-full max-w-md flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
                ...
                <p className="text-gray-600 dark:text-[#92a4c9] text-base font-normal leading-normal">
                    Join Horizon to start managing your finances today.
                </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <label className="flex flex-col flex-1">
                    ...
                    <input
                      ...
                      border-gray-300 dark:border-[#324467] bg-white dark:bg-[#192233] h-14 p-[15px]
                        text-base font-normal leading-normal text-gray-900 dark:text-white focus:outline-0
                        focus:ring-2 focus:ring-primary/50 focus:border-primary dark:focus:border-primary placeholder:text-gray-400
                        dark:placeholder:text-[#92a4c9]"
                ...
                <label className="flex flex-col flex-1">
                    ...
                    <input
                        ...
                        border-gray-300 dark:border-[#324467] bg-white dark:bg-[#192233] h-14 p-[15px]
                        text-base font-normal leading-normal text-gray-900 dark:text-white focus:outline-0 
                        focus:ring-2 focus:ring-primary/50 focus:border-primary dark:focus:border-primary
                      placeholder:text-gray-400 dark:placeholder:text-[#92a4c9]"
                     ...
                     bg-white dark:bg-[#192233] focus-within:ring-2 focus-within:ring-primary/50 focus-within:border-primary
                      dark:focus-within:border-primary transition-all duration-200 overflow-hidden">
                        <input
                            ...
                            className="flex-1 w-full min-w-0 bg-transparent h-14 p-[15px] text-base font-normal text-gray-900
                            dark:text-white placeholder:text-gray-400 dark:placeholder:text-[#92a4c9] focus:outline-none
                        ...
                        <button
                            ...
                            className="flex items-center justify-center px-[15px] text-gray-500 dark:text-[#92a4c9]
                            hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition-colors cursor-pointer"
                            tabIndex={-1}
                        >
                            {showPassword ? (
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="relative flex items-center">
                    <div className="grow border-t border-gray-300 dark:border-[#324467]"></div>
                    <span className="mx-4 shrink text-sm text-gray-500 dark:text-[#92a4c9]">Or continue with</span>
                    <div className="grow border-t border-gray-300 dark:border-[#324467]"></div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                    <button type="button" className="flex items-center justify-center gap-3 rounded-lg border border-gray-300 dark:border-[#324467] bg-white dark:bg-[#192233] px-4 py-3 text-sm font-medium text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        {/* Google Icon */}
